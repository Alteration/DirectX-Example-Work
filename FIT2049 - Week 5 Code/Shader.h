...
public:
	...
	virtual bool Initialise(ID3D11Device* device, LPCWSTR vertexFilename, LPCWSTR pixelFilename, LPCWSTR geometryFilename);	//Initialises the shader, here we specify the file name of the 
